...
Given a set of structured signals extracted from a company's career pages and engineering blogs,
your task is to produce a concise, actionable opportunity assessment.
...
async def run_ai_inference(
    ...
    user_prompt = _build_user_prompt(signals, company_name)
